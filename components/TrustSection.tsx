...
const trustItems = [
  ...
  { icon: ShieldCheck, title: 'Honest Confidence', copy: 'If local information is incomplete, GramVyapar tells you.' },
] as const;
  ...
  return (
    <section id="about" className="section-shell bg-[#EFF7FF]">
      <div className="section-container">
        <SectionHeader eyebrow="Seedhi aur sachchi advice" title="GramVyapar Aapko Guess Karke Advice Nahi Deta." description="Aapko pata rahega ki information kahan se aayi aur numbers kaise nikle." align="center" />
